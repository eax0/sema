      ...
      element.on('drop', function(event) {
        ...
        scope.$apply(function() {
          targetArray.splice(index, 0, transferredObject);
            /*var currItem = targetArray[targetArray.indexOf(transferredObject)];
            var newSort = targetArray[index-1].sort;
            targetArray[index-1].sort = currItem.sort;
            currItem.sort = newSort;*/
        });
